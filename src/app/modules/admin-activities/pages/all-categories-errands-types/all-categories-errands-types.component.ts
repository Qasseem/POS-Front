...
@Component({
  selector: 'app-all-categories-errands-types',
  templateUrl: './all-categories-errands-types.component.html',
  styleUrls: ['./all-categories-errands-types.component.css'],
})
export class AllCategoriesErrandsTypesComponent implements OnInit {
