...
@Component({
  selector: 'app-all-pos-types',
  templateUrl: './all-pos-types.component.html',
  styleUrls: ['./all-pos-types.component.css'],
})
export class AllPOSTypesComponent implements OnInit {
