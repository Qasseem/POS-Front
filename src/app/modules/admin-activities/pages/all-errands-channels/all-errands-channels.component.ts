...
@Component({
  selector: 'app-all-errands-channel',
  templateUrl: './all-errands-channels.component.html',
  styleUrls: ['./all-errands-channels.component.css'],
})
export class AllErrandsChannelsComponent implements OnInit {
